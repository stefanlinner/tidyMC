...
Using MCS on computers has the greate advantage that, with the necessary informations, the simulations results can be replicated everywhere. This is possible because the given seed and algorithm the numbers created by a random number generator are completely reproducable. 

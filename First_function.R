...
martin_vs_tidyMC <- function(reps, cores){
  ...
  combs <- c("6 combinations", "12 combinations", "18 combinations")

  pars <- list("6 combinations" = list(n = c(1e3, 1e3, 1e4), param = seq(from = 0, to = 1, by = 0.5),
                     x1 = 1, x2 = 2),
                "12 combinations" = list(n = c(1e2, 1e3, 1e4), param = seq(from = 0, to = 1, by = 0.5),
                          x1 = 1, x2 = c(2,4)),
                "18 combinations" = list(n = c(1e2, 1e3, 1e4), param = seq(from = 0, to = 1, by = 0.5),
                          x1 = 1, x2 = c(2,3,4))
                    )
...
martin_vs_tidyMC_plot <- martin_vs_tidyMC(reps = c(1e1, 1e2),
                                           cores = c(2,3))

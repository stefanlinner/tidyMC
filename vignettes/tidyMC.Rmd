...
<!-- The attentive reader might have already noticed that we misspecified the variance ?`sigma2 = -2`. By definition, the variance is non-negative and the used function is hence nonsenscial. As expected, the failed check informs about the source of the mistake, which impacts all parameter combinations specified.-->
...
<!-- We need to mention the new argument which_path -->
